...
1. ใช้ไฟล์ `scripts/test-download-domain-report.js`
// turbo
2. รันคำสั่ง โดยระบุชื่อ Account และ Zone:
```bash
node scripts/test-download-domain-report.js "Account Name" "zone.com"
```

### สำหรับ Batch Report (หลายโดเมน)
1. ใช้ไฟล์ `scripts/test-download-batch-report.js`
// turbo
2. รันคำสั่ง โดยระบุชื่อ Account, Zone และ List ของ Subdomain:
```bash
node scripts/test-download-batch-report.js "Account Name" "zone.com" "sub1,sub2,sub3"
```
