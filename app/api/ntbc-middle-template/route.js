...
const defaultFile = path.join(dataDir, 'ntbc_middleReportTemplate.json');
...
export async function GET(request) {
    ...
    if (id && id !== 'default') {
        ...
        filePath = path.join(templatesDir, `ntbc_t_${safeId}_middle.json`);
    }
    ...
    try {
        ...
        console.error(`Failed to load middle template ${id}:`, error);
